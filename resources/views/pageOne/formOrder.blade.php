            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.html"> <img src="{{asset('assets/front/img/logo.png')}}"
                                alt="logo"> </a>
                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="{{url($produk->foto)}}" alt=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <form class="form-contact contact_form"
                                                        action="{{route('form.insert', ['id'=> $produk->id])}}"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="label label-danger"
                                                                        style="color:red">{{$errors->first('amount')}}</span>
                                                                    @endif
                                                                    <input class="form-control" name="amount"
                                                                        id="subject" type="text"
                                                                        onfocus="this.placeholder = ''"
                                                                        onblur="this.placeholder = 'Enter Your Amount'"
                                                        ...
                                                        <div class="form-group mt-3">
                                                            <button type="submit"
                                                                class="button button-contactForm btn_1">Submit</button>
                                                        </div>
                                                    </form>
                                                </div>
